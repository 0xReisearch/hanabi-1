...
def make_predictions(
    ...
    # Calibrate direction threshold if requested
    if calibrate_threshold:
        logger.info("Calibrating direction threshold...")
        # Use validation data to find optimal threshold
        # Here we're using a simple approach: aim for balanced prediction distribution
    ...
    # Join with actual values if available
    pred_df = pd.merge(
        pred_df,
